...
| 26 | Mar 2026 | [`java26`](src/main/java/net/jrodolfo/java_evolution/java26/README.md) | HTTP/3, Final Field restrictions, and Applet API removal examples, AOT Object Caching, G1, PEM/Structured Concurrency/Lazy Constants/Vector/Primitive Patterns notes |
