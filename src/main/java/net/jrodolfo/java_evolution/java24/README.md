...
- primitive patterns second preview, documented in [`primitive_patterns`](primitive_patterns/README.md) and continued in Java 25 as `PrimitivePatternsThirdPreviewExamples`
