...
This repository keeps hidden classes as notes because a realistic example usually requires bytecode generation, which would distract from the Java release feature itself.

Example: `HiddenClassesNotes`
