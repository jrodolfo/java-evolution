...
| Internet-Address Resolution SPI | [`inet_address_resolution/InetAddressResolutionExamples`](../src/main/java/net/jrodolfo/java_evolution/java18/inet_address_resolution/InetAddressResolutionExamples.java) | [`InetAddressResolutionExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java18/inet_address_resolution/InetAddressResolutionExamplesTest.java) |
...
| Vector API fifth incubator | [`VectorApiFifthIncubatorExamples`](../src/main/java/net/jrodolfo/java_evolution/java20/vector_api/VectorApiFifthIncubatorExamples.java) | [`VectorApiFifthIncubatorExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java20/vector_api/VectorApiFifthIncubatorExamplesTest.java) |
...
| Unsafe memory-access deprecation | [`UnsafeMemoryAccessDeprecationExamples`](../src/main/java/net/jrodolfo/java_evolution/java23/unsafe_memory_access_deprecation/UnsafeMemoryAccessDeprecationExamples.java) | [`UnsafeMemoryAccessDeprecationExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java23/unsafe_memory_access_deprecation/UnsafeMemoryAccessDeprecationExamplesTest.java) |
| ZGC generational mode | [`ZgcGenerationalModeExamples`](../src/main/java/net/jrodolfo/java_evolution/java23/zgc_generational_mode/ZgcGenerationalModeExamples.java) | [`ZgcGenerationalModeExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java23/zgc_generational_mode/ZgcGenerationalModeExamplesTest.java) |
...
| Security Manager disabled | [`SecurityManagerDisabledExamples`](../src/main/java/net/jrodolfo/java_evolution/java24/security_manager_disabled/SecurityManagerDisabledExamples.java) | [`SecurityManagerDisabledExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java24/security_manager_disabled/SecurityManagerDisabledExamplesTest.java) |
| Virtual-thread synchronization | [`VirtualThreadSynchronizationExamples`](../src/main/java/net/jrodolfo/java_evolution/java24/virtual_thread_synchronization/VirtualThreadSynchronizationExamples.java) | [`VirtualThreadSynchronizationExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java24/virtual_thread_synchronization/VirtualThreadSynchronizationExamplesTest.java) |
...
| AOT class loading | [`AotClassLoadingExamples`](../src/main/java/net/jrodolfo/java_evolution/java24/aot_class_loading/AotClassLoadingExamples.java) | [`AotClassLoadingExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java24/aot_class_loading/AotClassLoadingExamplesTest.java) |
...
| Module import declarations final | `ModuleImportDeclarationsExamples` | `ModuleImportDeclarationsExamplesTest` |
...
| Primitive patterns third preview | [`PrimitivePatternsThirdPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/PrimitivePatternsThirdPreviewExamples.java) | [`PrimitivePatternsThirdPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/PrimitivePatternsThirdPreviewExamplesTest.java) |
| Stable values preview | [`StableValuesPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/stable_values/StableValuesPreviewExamples.java) | [`StableValuesPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/stable_values/StableValuesPreviewExamplesTest.java) |
| PEM encodings preview | [`PemEncodingsPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/PemEncodingsPreviewExamples.java) | [`PemEncodingsPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/PemEncodingsPreviewExamplesTest.java) |
| Structured concurrency fifth preview | [`StructuredConcurrencyFifthPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/structured_concurrency/StructuredConcurrencyFifthPreviewExamples.java) | [`StructuredConcurrencyFifthPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/structured_concurrency/StructuredConcurrencyFifthPreviewExamplesTest.java) |
| Vector API tenth incubator | [`VectorApiTenthIncubatorExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/vector_api/VectorApiTenthIncubatorExamples.java) | [`VectorApiTenthIncubatorExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/vector_api/VectorApiTenthIncubatorExamplesTest.java) |
| AOT command-line ergonomics | [`AotCommandLineErgonomicsExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/aot_command_line/AotCommandLineErgonomicsExamples.java) | [`AotCommandLineErgonomicsExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/aot_command_line/AotCommandLineErgonomicsExamplesTest.java) |
| JFR enhancements | [`JfrEnhancementsExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/jfr_enhancements/JfrEnhancementsExamples.java) | [`JfrEnhancementsExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/jfr_enhancements/JfrEnhancementsExamplesTest.java) |
| Compact object headers | [`CompactObjectHeadersExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/compact_object_headers/CompactObjectHeadersExamples.java) | [`CompactObjectHeadersExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java25/compact_object_headers/CompactObjectHeadersExamplesTest.java) |
...
Java 26 contains nine executable examples and one explanatory module. HTTP/3 is executable because the JDK 26 API surface is final and can be demonstrated deterministically without live networking. Final-field restrictions are executable because the Java 26 warning can be captured in an isolated child JVM. Applet API removal is executable because the removed package can be verified with a deterministic child-compiler example. AOT object caching is executable because cache creation and reuse can be verified in isolated child JVMs without measuring startup performance. PEM encodings are executable because a deterministic in-memory envelope round trip can be compiled and run in an isolated JDK 26 child JVM with matching preview flags. Lazy Constants are executable because deferred initialization, one-time evaluation, and value reuse can be verified with an in-memory supplier in an isolated JDK 26 child JVM. Primitive patterns are executable because their preview syntax can be compiled and run in an isolated JDK 26 child JVM with matching preview flags. Structured Concurrency is executable because scope joining and failure propagation can be verified in an isolated JDK 26 child JVM without relying on scheduler timing or cancellation races. The Vector API is executable because a real incubator vector operation can be compiled and run in an isolated JDK 26 child JVM. G1 synchronization reduction remains explanatory because its runtime effect requires workload measurement.
...
| Final field restrictions | [`FinalFieldRestrictionsExamples`](../src/main/java/net/jrodolfo/java_evolution/java26/final_field_restrictions/FinalFieldRestrictionsExamples.java) | [`FinalFieldRestrictionsExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java26/final_field_restrictions/FinalFieldRestrictionsExamplesTest.java) |
...
| AOT object caching | [`AotObjectCachingExamples`](../src/main/java/net/jrodolfo/java_evolution/java26/aot_object_caching/AotObjectCachingExamples.java) | [`AotObjectCachingExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java26/aot_object_caching/AotObjectCachingExamplesTest.java) |
...
| PEM encodings second preview | [`PemEncodingsSecondPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java26/PemEncodingsSecondPreviewExamples.java) | [`PemEncodingsSecondPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java26/PemEncodingsSecondPreviewExamplesTest.java) |
| Structured concurrency sixth preview | [`StructuredConcurrencySixthPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java26/structured_concurrency/StructuredConcurrencySixthPreviewExamples.java) | [`StructuredConcurrencySixthPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java26/structured_concurrency/StructuredConcurrencySixthPreviewExamplesTest.java) |
| Lazy Constants second preview | [`LazyConstantsSecondPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java26/lazy_constants/LazyConstantsSecondPreviewExamples.java) | [`LazyConstantsSecondPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java26/lazy_constants/LazyConstantsSecondPreviewExamplesTest.java) |
...
| Primitive patterns fourth preview | [`PrimitivePatternsFourthPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java26/PrimitivePatternsFourthPreviewExamples.java) | [`PrimitivePatternsFourthPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java26/PrimitivePatternsFourthPreviewExamplesTest.java) |

## Java 27

Learning notes: [java27 README](../src/main/java/net/jrodolfo/java_evolution/java27/README.md)

Java 27 adds executable examples for deterministic VM, TLS, and JFR configuration observations and for the continuing preview APIs. G1 default selection and the Vector API remain explanatory modules because useful evidence requires workloads or incubator-specific duplication.

| Feature | Example or Notes Class | Test Class |
|---|---|---|
| G1 default collector | [`G1DefaultNotes`](../src/main/java/net/jrodolfo/java_evolution/java27/g1_default/G1DefaultNotes.java) | [`G1DefaultNotesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/g1_default/G1DefaultNotesTest.java) |
| Compact Object Headers by default | [`CompactObjectHeadersDefaultExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/compact_object_headers/CompactObjectHeadersDefaultExamples.java) | [`CompactObjectHeadersDefaultExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/compact_object_headers/CompactObjectHeadersDefaultExamplesTest.java) |
| Post-quantum hybrid TLS key exchange | [`PostQuantumHybridKeyExchangeExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/tls_hybrid_key_exchange/PostQuantumHybridKeyExchangeExamples.java) | [`PostQuantumHybridKeyExchangeExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/tls_hybrid_key_exchange/PostQuantumHybridKeyExchangeExamplesTest.java) |
| JFR redaction-option availability | [`JfrRedactionOptionExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/jfr_data_redaction/JfrRedactionOptionExamples.java) | [`JfrRedactionOptionExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/jfr_data_redaction/JfrRedactionOptionExamplesTest.java) |
| Lazy Constants third preview | [`LazyConstantsThirdPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/lazy_constants/LazyConstantsThirdPreviewExamples.java) | [`LazyConstantsThirdPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/lazy_constants/LazyConstantsThirdPreviewExamplesTest.java) |
| Primitive patterns fifth preview | [`PrimitivePatternsFifthPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/primitive_patterns/PrimitivePatternsFifthPreviewExamples.java) | [`PrimitivePatternsFifthPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/primitive_patterns/PrimitivePatternsFifthPreviewExamplesTest.java) |
| Structured concurrency seventh preview | [`StructuredConcurrencySeventhPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/structured_concurrency/StructuredConcurrencySeventhPreviewExamples.java) | [`StructuredConcurrencySeventhPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/structured_concurrency/StructuredConcurrencySeventhPreviewExamplesTest.java) |
| PEM encodings third preview | [`PemEncodingsThirdPreviewExamples`](../src/main/java/net/jrodolfo/java_evolution/java27/pem_encodings/PemEncodingsThirdPreviewExamples.java) | [`PemEncodingsThirdPreviewExamplesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/pem_encodings/PemEncodingsThirdPreviewExamplesTest.java) |
| Vector API twelfth incubator | [`VectorApiTwelfthIncubatorNotes`](../src/main/java/net/jrodolfo/java_evolution/java27/vector_api/VectorApiTwelfthIncubatorNotes.java) | [`VectorApiTwelfthIncubatorNotesTest`](../src/test/java/net/jrodolfo/java_evolution/java27/vector_api/VectorApiTwelfthIncubatorNotesTest.java) |
