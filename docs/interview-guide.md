...
- This repository now builds on JDK 26 while keeping only the not-yet-evaluated Java 26 feature modules notes-only. HTTP/3, final-field restrictions, Applet API removal, and AOT object caching already have focused executable examples.
