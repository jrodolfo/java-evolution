...
| 25 | Scoped Values | [`scoped_values`](../src/main/java/net/jrodolfo/java_evolution/java25/scoped_values/README.md) | Shows temporary scoped bindings for contextual data and verifies that the value is unbound afterward. | `mvn -Dtest=ScopedValuesExamplesTest test` | JDK 25. |
| 25 | Flexible Constructor Bodies | [`FlexibleConstructorBodiesExamples`](../src/main/java/net/jrodolfo/java_evolution/java25/FlexibleConstructorBodiesExamples.java) | Demonstrates validation and normalization before constructor delegation. | `mvn -Dtest=FlexibleConstructorBodiesExamplesTest test` | JDK 25. |
| 25 | Key Derivation Function API | [`key_derivation`](../src/main/java/net/jrodolfo/java_evolution/java25/key_derivation/README.md) | Derives independent keys from shared secret material with HKDF. | `mvn -Dtest=HkdfKeyDerivationExampleTest test` | Requires JDK 25 KDF support. |
