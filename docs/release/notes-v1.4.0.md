...
```bash
mvn "-Dtest=Http3ClientNotesTest,PemEncodingsSecondPreviewNotesTest,PrimitivePatternsFourthPreviewNotesTest,FinalFieldRestrictionsNotesTest,AppletApiRemovalNotesTest,AotObjectCachingNotesTest,G1SynchronizationNotesTest,StructuredConcurrencySixthPreviewNotesTest,LazyConstantsSecondPreviewNotesTest,VectorApiEleventhIncubatorNotesTest" test
